        ...
        <>
            <footer className="w-full h-[32rem] flex flex-col justify-between mt-20 border-t-2 border-gray-300 px-8 lg:px-20 py-10">
                <div className="w-full flex flex-wrap lg:gap-0 justify-between mb-8">
                    <div className="mb-12 lg:mb-0 flex lg:items-start w-[40%] sm:w-1/2 md:w-1/3 lg:w-1/4 flex-col gap-1">
                    ...
                    <div className="mb-12 lg:mb-0 w-[100%] flex flex-col justify-center items-center lg:items-start sm:w-1/2 md:w-1/3 lg:w-1/4">
                        <p className="font-[500]     lg:text-center">GET IN THE KNOW</p>
                ...
                <div className="w-full flex flex-wrap gap-4 text-center lg:gap-0 justify-center lg:justify-between border-t border-gray-400 py-8">
                    <div>
                        ...
                        <p className="mt-3 lg:mt-0 font-medium hover:cursor-pointer border-b-2 border-transparent hover:border-b-2 hover:border-gray-600">Privacy Policy <span className="ml-6 lg:ml-3">terms of Service</span></p>
                    </div>
