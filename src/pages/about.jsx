    ...
    return(
        <>
            ...
            <main className="flex flex-col gap-24 lg:gap-48 items-center pb-20 ">
                <div className="lg:w-[64%] px-8 lg:px-0 lg:flex flex-wrap justify-center lg:gap-12">
                    <img className="lg:w-[26%] h-[16rem]" src={img5} alt="" />
                ...
                <div className="lg:w-[64%] px-8 lg:px-0 lg:flex flex-wrap justify-center lg:gap-12">
                    <img className="lg:w-[26%] h-[16rem]" src={img6} alt="" />
                    <div className="w-[64%] flex flex-col justify-between">
                        <img className="w-fit" src={img8} alt="" />
                ...
                <div className="lg:w-[64%] px-8 lg:px-0 lg:flex flex-wrap justify-center lg:gap-12">
                    <img className="lg:w-[26%] h-[16rem]" src={img7} alt="" />
                    <div className="w-[64%] flex flex-col justify-between">
                        <img className="w-fit" src={img8} alt="" />
